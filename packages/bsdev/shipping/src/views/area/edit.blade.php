    ...
    <div class="container-fluid">
        ...
        <div class="card card-primary">
            ...
            <div class="card-body">
                ...
                @endif
                <form class="row form" method="post" action="{{ route('areas.update',$area->id) }}"
                    ...
                    <div class="col-md-7">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="position" name="position"
                                placeholder="Enter position" value="{{ $area->position }}">
                        </div>
                        <!-- /.form-group -->
                    </div>
                    <!-- /.col -->
                    <div class="col-md-5">
                        <div class="form-group">
                            ...
                            <select name="district_id" class="form-control select2">
                                ...
                                @foreach(Shipping::getDistricts() as $district)
                                <option value="{{ $district->id }}"
                                    {{ ($area->district_id==$district->id)?'selected':'' }}>
                        ...
                        <div class="card card-info">
                            ...
                            <div class="card-body">
                                <input type="checkbox" name="status" value="1" data-bootstrap-switch
                                    data-off-color="danger" data-on-color="success" {{ ($area->status)?'checked':'' }}>
                            </div>
                        </div>
