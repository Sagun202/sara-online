    ...
    <div class="container-fluid">
        ...
        <div class="card card-primary">
            ...
            <div class="card-body">
                ...
                @endif
                <form class="row form" method="post" action="{{ route('shippings.store') }}"
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="shipping_param">
                                        ...
                                        <option value="{{ $param }}" {{ old('shipping_param')==$param?'selected':'' }}>
                                            {{ $param }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="form-group">
                                    ...
                                    <input type="text" name="shipping_param_min" value="{{ old('shipping_param_min') }}"
                                        class="form-control">
                                </div>
                                <div class="form-group">
                                    <label for="parameter_max">Parameter Max</label>
                                    <input type="text" name="shipping_param_max" value="{{ old('shipping_param_max') }}"
                                        class="form-control">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="time_param">
                                        ...
                                        <option value="{{ $param }}" {{ old('time_param')==$param?'selected':'' }}>
                                            {{ $param }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="form-group">
                                    <label for="parameter_min">Parameter Min</label>
                                    <input type="text" name="time_param_min" value="{{ old('time_param_min') }}"
                                        class="form-control">
                                </div>
                                <div class="form-group">
                                    <label for="parameter_max">Parameter Max</label>
                                    <input type="text" name="time_param_max" value="{{ old('time_param_max') }}"
                                        class="form-control">
                                </div>
                            </div>
                        </div>
