    ...
    <div class="container-fluid">
        ...
        <div class="card card-primary">
            ...
            <div class="card-body">
                ...
                @endif
                <form class="row form" method="post" action="{{ route('teams.update',$team->id) }}" enctype="multipart/form-data">
                    @csrf
                    @method('put')
                    <div class="col-md-7">
                        <div class="card card-success">
                            ...
                            <div class="card-body">
                                ...
                                <input type="text" class="form-control" id="phone" name="phone"
                                    placeholder="Enter phone" value="{{ $team->phone }}">
                            </div>
                        ...
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                <textarea id="description" class="form-control" name="introduction" rows="3"
                                    placeholder="Enter Breif Introduction">{{ $team->introduction }}</textarea>
                            </div>
                        </div>
                        <!-- /.form-group -->
                    </div>
                    ...
                    <div class="col-md-5">
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="designation_id" id="designation_id">
                                ...
                                <option value="{{ $designation->id }}"
                                    {{ ($designation->id==$team->designation_id)?'selected':'' }}>
                                    {{ $designation->name }}
                                </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <div class="d-flex mt-2">
                                <img src="@if($team->image) {{ asset('storage/'.$team->image) }} @endif" class="preview img-fluid" style="max-height: 200px; max-width:auto;">
                            </div>
                        </div>
                        ...
                        <div class="card card-success">
                            ...
                            <div class="card-body">
                                ...
                                <input type="text" class="form-control" id="youtube" name="youtube"
                                    placeholder="Enter YouTube Link" value="{{ $team->youtube }}">
                            </div>
                            <div class="card-body">
                                <label for="linkedin">Linkedin</label>
                                <input type="text" class="form-control" id="linkedin" name="linkedin"
                                    placeholder="Enter linkedin Link" value="{{ $team->linkedin }}">
                            </div>
                            <div class="card-body">
                                <label for="website">Website</label>
                                <input type="text" class="form-control" id="website" name="website"
                                    placeholder="Enter Website Link" value="{{ $team->website }}">
                            </div>
                        </div>
                        <div class="card card-info">
                            ...
                            <div class="card-body">
                                <input type="checkbox" name="status" value="1" data-bootstrap-switch
                                    data-off-color="danger" data-on-color="success" {{ ($team->status)?'checked':'' }}>
                            </div>
                        </div>
