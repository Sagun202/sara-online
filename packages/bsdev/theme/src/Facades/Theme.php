...
use Bsdev\Theme\Jobs\SendMailJob;
use Bsdev\Theme\Models\CMS;
use Bsdev\Theme\Models\Faq;
use Bsdev\Theme\Models\Menu;
use Bsdev\Theme\Models\Setting;
use Bsdev\Theme\Models\Site;
use Bsdev\Theme\Models\Subscription;
use Bsdev\Theme\Models\Testimonial;
use Bsdev\Theme\Requests\StoreSubscriptionRequest;
use Bsdev\Theme\Traits\Component;
use File;
...
class Theme
{
    ...
    public function menu()
    {
        ...
        foreach ($packages as $key => $package) {
            $files = collect(File::allFiles(base_path('vendor/bsdev/' . strtolower($package) . '/src/Facades/')))
                ->sortBy(function ($file) {
                    return $file->getBaseName();
                });
            if ($files) {
                $namesapce = "Bsdev\\" . $package . "\Facades\\" . $package;
