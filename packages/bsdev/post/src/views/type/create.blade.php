    ...
    <div class="container-fluid">
        ...
        <div class="card card-primary">
            ...
            <div class="card-body">
                ...
                @endif
                <form class="row form" method="post" action="{{ route('types.store') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="col-md-7">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="short_introduction" rows="5"
                                placeholder="Enter Short Description">{{ old('short_introduction') }}</textarea>
                        </div>
                    </div>
                    <!-- /.col -->
                    <div class="col-md-5">
