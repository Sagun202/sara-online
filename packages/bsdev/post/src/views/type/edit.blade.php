    ...
    <div class="container-fluid">
        ...
        <div class="card card-primary">
            ...
            <div class="card-body">
                ...
                @endif
                <form class="row form" method="post" action="{{ route('types.update',$type->id) }}"
                    ...
                    <div class="col-md-7">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="short_introduction" rows="5"
                                placeholder="Enter Short Description">{{ $type->short_introduction }}</textarea>
                        </div>
                    </div>
                    <!-- /.col -->
                    <div class="col-md-5">
                        ...
                        <div class="card card-info">
                            ...
                            <div class="card-body">
                                <input type="checkbox" name="status" value="1" data-bootstrap-switch
                                    data-off-color="danger" data-on-color="success" {{ ($type->status)?'checked':'' }}>
                            </div>
                        </div>
