    ...
    <div class="container-fluid">
        ...
        <div class="card card-primary">
            ...
            <div class="card-body">
                ...
                @endif
                <form class="row form" method="post" action="{{ route('postcomment.update',$postcomment->id) }}"
                    ...
                    <div class="col-md-7">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="message" rows="5"
                                placeholder="Enter Short Introduction">{{ $postcomment->message }}</textarea>
                        </div>
                        <!-- /.form-group -->
                    </div>
                    <!-- /.col -->
                    <div class="col-md-5">
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="post_id" id="post_id">
                                ...
                                <option value="{{ $post->id }}" {{ ($post->id==$postcomment->post_id)?'selected':'' }}>
                                    {{ $post->title }}</option>
                                @endforeach
                            </select>
                        </div>
