    ...
    <div class="container-fluid">
        ...
        <div class="card card-primary">
            ...
            <div class="card-body">
                ...
                @endif
                <form class="row form" method="post" action="{{ route('brands.store') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="col-md-7">
...
<script>
    $('.brand-menu').removeClass('menu-is-opening menu-open');
        $('.brand-menu').addClass('menu-is-opening menu-open');
        $('.brand-menu').find('>:first-child').removeClass('active');
        $('.brand-menu').find('>:first-child').addClass('active');
    $(function(){
        $('.select2').select2({
        theme: 'bootstrap4'
        })
