    ...
    <div class="container-fluid">
        ...
        <div class="card card-primary">
            ...
            <div class="card-body">
                ...
                @endif
                <form class="row form" method="post" action="{{ route('sliders.update',$slider->id) }}"
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="short_description" rows="5"
                                placeholder="Enter Short Description">{{ $slider->short_description }}</textarea>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="position" name="position"
                                placeholder="Enter position" value="{{ $slider->position }}">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="d-flex mt-2">
                                <img src="{{ ($slider->image)?asset('storage/'.$slider->image):'' }}" class="preview img-fluid" style="max-height: 200px; max-width:auto;">
                            </div>
                        </div>
                        <div class="card card-info">
                            ...
                            <div class="card-body">
                                <input type="checkbox" name="status" value="1" data-bootstrap-switch
                                    data-off-color="danger" data-on-color="success" {{ ($slider->status)?'checked':'' }}>
                            </div>
                        </div>
