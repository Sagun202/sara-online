    ...
    <div class="container-fluid">
        ...
        <div class="card card-primary">
            ...
            <div class="card-body">
                ...
                @endif
                <form class="row form" method="post" action="{{ route('sliders.store') }}"
...
<script>
        $('.slider-menu').removeClass('menu-is-opening menu-open');
        $('.slider-menu').addClass('menu-is-opening menu-open');
        $('.slider-menu').find('>:first-child').removeClass('active');
        $('.slider-menu').find('>:first-child').addClass('active');
    $(function(){
