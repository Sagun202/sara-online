...
<div class="row" style="align-content: center; align-items:center; justify-content: center;  ">
            ...
            <div class="col-2">
               <center>
                  <button class=" rounded-pill btn-primary" style="background: #001768; color:white; font-size:20px; font-weight:600; "> HOT  DEALS</button>
               </center>
    ...
    <div class="super-deal padd" >
        <div class="product-block" style="background-color: white; padding: 10px; border-radius: 5px;" >
              ...
              <div style="float:right" class="seeall">
                 <p>
                    <a href="{{ route('product.list','hot-products') }}">
