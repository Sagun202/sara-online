<form wire:ignore.self class="register-modal-form" wire:submit.prevent="register">
    ...
    @enderror
        ...
        <div class="form-group">
        <label for="register-modal-address">Address</label>
        <input type="text" class="form-control" wire:model.defer="address" id="register-modal-address"
    ...
    @enderror
        ...
        <div class="form-group">
        <label for="register-modal-address2">Address2</label>
        <input type="text" class="form-control" wire:model.defer="address2" id="register-modal-address2"
            aria-describedby="textHelp" placeholder="Enter your address2" />
    </div>
    @error('address2')
    <div class="alert alert-danger" role="alert">
        {{ $message }}
