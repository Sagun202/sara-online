    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->editColumn('show_in_home', function (Category $category) {
                return $category->show_in_home ? '<span style="color:white;background-color:green; padding:5px; border-radius:10px;">Published</span>' : '<span style="color:white;background-color:red; padding:5px; border-radius:10px;">Unpublished</span>';
            })
            ->escapeColumns([]);
    }
