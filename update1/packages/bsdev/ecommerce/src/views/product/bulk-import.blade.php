        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Bulk Product Import</li>
                </ol>
            </div>
        </div>
    </div><!-- /.container-fluid -->
    ...
    <div class="container-fluid">
        ...
        <div class="card card-primary">
            ...
            <div class="card-body">
                ...
                @endif
                <form class="row form" method="post" action="{{ route('products.import') }}"
                    enctype="multipart/form-data">
                    @csrf
                    <div class="col-md-7">
                        <div class="form-group">
                            <label for="exampleInputFile">File <small>(Excel File supported files
                                    xlxs,xls)</small></label>
                            <div class="input-group">
                                <div class="custom-file">
                                    <input type="file" name="file" class="custom-file-input file-input"
                                        id="exampleInputFile">
                    ...
                    <div class="col-md-5">
                        <div class="form-group">
                            <a href="{{ asset('product_import_format.xlsx') }}" download="product_import_format.xlsx"
                                class="btn btn-success">Download Sample File</a>
                        </div>
                    </div>
