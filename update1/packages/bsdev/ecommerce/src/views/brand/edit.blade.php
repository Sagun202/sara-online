    ...
    <div class="container-fluid">
        ...
        <div class="card card-primary">
            ...
            <div class="card-body">
                ...
                @endif
                <form class="row form" method="post" action="{{ route('brands.update',$brand->id) }}"
                    ...
                    <div class="col-md-7">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" value="{{ $brand->position }}" name="position" class="form-control">
                        </div>
                        <div class="form-group">
                            ...
                            <div class="d-flex mt-2">
                                <img src="{{ asset('storage/'.$brand->image) }}" class="preview img-fluid" style="max-height: 200px; max-width:auto;">
                            </div>
                        </div>
                        ...
                        <div class="card card-success">
                            ...
                            <div class="card-body">
                                ...
                                <input type="text" class="form-control" id="met_title" name="meta_title"
                                    placeholder="Enter Meta Title" value="{{ $brand->seo['meta_title']??'' }}">
                            </div>
                            <!-- /.card-body -->
                            <div class="card-body">
                                <label>Meta Description</label>
                                <textarea class="form-control" name="meta_description" rows="5"
                                    placeholder="Enter Meta Description">{{ $brand->seo['meta_description']??'' }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="card card-info">
                            ...
                            <div class="card-body">
                                <input type="checkbox" name="status" value="1" data-bootstrap-switch
                                    data-off-color="danger" data-on-color="success" {{ ($brand->status)?'checked':'' }}>
                            </div>
                        </div>
