    ...
    <div class="container-fluid">
        ...
        <div class="card card-primary">
            ...
            <div class="card-body">
                ...
                @endif
                <form class="row form" method="post" action="{{ route('advertisements.store') }}"
                    ...
                    <div class="col-md-7">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="link" name="link"
                                placeholder="Enter Link">{{ old('link') }}</textarea>
                        </div>
                        ...
                        <div class="card card-success">
                            ...
                            <div class="card-body">
                                ...
                                <input type="date" class="form-control" id="expire_at" name="expire_at"
                                    placeholder="Select Expire date" value="{{ old('expire_at') }}">
                            </div>
                            <!-- /.card-body -->
