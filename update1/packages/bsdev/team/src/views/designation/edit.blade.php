    ...
    <div class="container-fluid">
        ...
        <div class="card card-primary">
            ...
            <div class="card-body">
                ...
                @endif
                <form class="row form" method="post" action="{{ route('designations.update',$designation->id) }}"
                    ...
                    <div class="col-md-7">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="position" name="position"
                                placeholder="Enter position" value="{{ $designation->position }}">
                        </div>
                    ...
                    <div class="col-md-5">
                        <div class="form-group">
                            <label for="designation_id">Parent Designation</label>
                            <select class="form-control select2" name="designation_id" id="designation_id">
                                <option value="">Choose Parent Designation</option>
                                @foreach(Team::getParentDesignation() as $desi)
                                <option value="{{ $desi->id }}"
                                    {{ ($desi->id==$designation->designation_id)?'selected':'' }}>{{ $desi->name }}
                                </option>
                                @endforeach
                            </select>
                        </div>
                        <div class="card card-info">
                            ...
                            <div class="card-body">
                                <input type="checkbox" name="status" value="1" data-bootstrap-switch
                                    data-off-color="danger" data-on-color="success" {{ ($designation->status)?'checked':'' }}>
                            </div>
                        </div>
