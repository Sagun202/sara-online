    ...
    <div class="container-fluid">
        ...
        <div class="card card-primary">
            ...
            <div class="card-body">
                ...
                @endif
                <form class="row form" method="post" action="{{ route('services.store') }}"
                    ...
                    <div class="col-md-5">
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="service_id" id="service_id">
                                ...
                                @foreach(Service::getParentService() as $service)
                                <option value="{{ $service->id }}"
                                    {{ ($service->id==old('service_id'))?'selected':'' }}>{{ $service->title }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group">
