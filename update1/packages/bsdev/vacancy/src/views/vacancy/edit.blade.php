        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Update Vacancy</li>
                </ol>
            </div>
        </div>
    </div><!-- /.container-fluid -->
    ...
    <div class="container-fluid">
        ...
        <div class="card card-primary">
            <div class="card-header">
                <h3 class="card-title">Update Vacancy</h3>
            ...
            <div class="card-body">
                ...
                @endif
                <form class="row form" method="post" action="{{ route('vacancies.update',$vacancy->id) }}"
                    ...
                    <div class="col-md-7">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="no_of_opening" name="no_of_opening"
                                placeholder="Enter no_of_opening" value="{{ $vacancy->no_of_opening }}">
                        </div>
                        <div class="form-group">
                            <label for="Type">Type</label>
                            <select class="form-control" name="type">
                                <option value="Part Time" {{ $vacancy->type==="Part Time"?'selected':'' }}>Part Time
                                </option>
                                <option value="Full Time" {{ $vacancy->type==="Full Time"?'selected':'' }}>Full Time
                                </option>
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="short_description" class="form-control" name="short_description" rows="5"
                                placeholder="Enter Short Description">{{ $vacancy->short_description }}</textarea>
                        </div>
                        <div class="form-group">
                            <label>Description</label>
                            <textarea id="description" class="form-control" name="description" rows="5"
                                placeholder="Enter Description">{{ $vacancy->description }}</textarea>
                        </div>
                        <!-- /.form-group -->
                    </div>
                    <!-- /.col -->
                    <div class="col-md-5">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" id="expire_at" name="expire_at"
                                placeholder="Enter expire_at" value="{{ $vacancy->expire_at }}">
                        </div>
                        <div class="card card-success">
                            ...
                            <div class="card-body">
                                ...
                                <input type="text" class="form-control" id="met_title" name="meta_title"
                                    placeholder="Enter Meta Title" value="{{ $vacancy->seo['meta_title']??'' }}">
                            </div>
                            <!-- /.card-body -->
                            <div class="card-body">
                                <label>Meta Description</label>
                                <textarea class="form-control" name="meta_description" rows="5"
                                    placeholder="Enter Meta Description">{{ $vacancy->seo['meta_description']??'' }}</textarea>
                            </div>
                        </div>
