    ...
    <div class="container-fluid">
        ...
        <div class="card card-primary">
            <div class="card-header">
                <h3 class="card-title">Update Shipping Method</h3>
            ...
            <div class="card-body">
                ...
                @endif
                <form class="row form" method="post" action="{{ route('shippingmethods.update',$shippingMethod->id) }}"
