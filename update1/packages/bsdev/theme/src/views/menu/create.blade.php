    ...
    <div class="container-fluid">
        ...
        <div class="card card-primary">
            ...
            <div class="card-body">
                ...
                @endif
                <form class="row form" method="post" action="{{ route('menus.store') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="col-md-7">
                    ...
                    <div class="col-md-5">
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="type" id="type">
                                ...
                                @foreach(\Bsdev\Theme\Models\Menu::TYPES as $type)
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="menu_id" id="menu_id">
                                ...
                                @foreach(Theme::getMenus() as $menu)
